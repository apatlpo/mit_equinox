...
def zarr_standard(V, client, F=None, out_dir=None, compressor=None):
    ...
    for v in V:
        ...
        iters, time = get_iters_time(v, data_dir, delta_t=25.0)
        #
        p = "C"
        if v is "SSU":
            p = "W"
            ...
            p = "S"
        #
        ds = get_compressed_data(
            v, data_dir, grid_dir, iters=iters, time=time, client=client, point=p
        )
        #
            ...
            try:
                if compressor is "default":
                    ...
                    ds.to_zarr(
                        ...
                        mode="w",
                        encoding={
                            key: {"compressor": compressor} for key in ds.variables
                        },
                    )
            except:
                print("Failure")
