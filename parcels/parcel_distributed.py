...
def spin_up_cluster(jobs):
    ...
    cluster, client = ut.spin_up_cluster("distributed",
                    jobs=jobs,
                    fraction=0.9,
                    walltime='06:00:00',
                    **jobqueuekw,
                    )
    logging.info("dashboard via ssh: "+
                 ut.dashboard_ssh_forward(client)
                )
...
if __name__ == '__main__':
    ...
    # to file
    logging.basicConfig(filename='distributed.log', 
                        level=logging.INFO,
                       )
